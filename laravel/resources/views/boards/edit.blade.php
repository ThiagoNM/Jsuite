...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            {{ __('Editar model') }}
            <form method="post" action="{{ route('models.update',$model,$file) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="mb-3">
                    <span>Manufacturer: </span><input name="manufacturer" type="text" value="{{$model->manufacturer}}"/>
                </div>
                <div class="mb-3">
